...
MAKE_SYSTEM_PROP(ACTIVITY,UIMUMASNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIMUMASNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIMUMASNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIMUMASNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIMUMASNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIMUMASNativeItemContactAdd);
