 ...
 * Copyright (c) 2009-2011 by MUMAS, Inc. All Rights Reserved.
...
//@interface MUMASObject : NSObject
//@end

@interface MUMASObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MUMASObject class]])
		{
			for (NSString *key in [[(MUMASObject*)o modules] allKeys])
			{
